...
namespace Urbiautos
{
    public partial class DetalleFactura : Form
    {
        ...
        public DetalleFactura(String ID)
        {
            InitializeComponent();
            ...
            List<List<String>> DatosVenta = DC.getFactura(ID);
            ...
            else
            {
                ...
                ruttxb.Text = DatosVenta[0][6];
                lblNeto.Text = DatosVenta[0][3];
                lbliva.Text = DatosVenta[0][4];
                lbltotal.Text = DatosVenta[0][5];
                nombretxb.Text = DatosVenta[0][7];
